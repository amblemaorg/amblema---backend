...
from app.services.school_year_service import SchoolYearService, CronDiagnosticosService, CronAddDiagnosticsService, CronClearApprovalHistoryService, ClearApprovalHistoryPastYearService
