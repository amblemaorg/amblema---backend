...
class StatisticsInactiveSponsorTest(unittest.TestCase):
    ...
    def test_statistics_inactive_sponsor(self):
        ...
        self.assertEqual(2,result['records'][0]['trimesterOne'])
        self.assertEqual(1,result['records'][0]['trimesterTwo'])
        self.assertEqual(1,result['records'][0]['trimesterThree'])
        self.assertEqual(1,result['records'][0]['trimesterFour'])
        ...
        self.assertEqual(2,result['records'][1]['trimesterOne'])
        self.assertEqual(1,result['records'][1]['trimesterTwo'])
        self.assertEqual(0,result['records'][1]['trimesterThree'])
