# app/tests/integration/statistics_active_sponsor_test.py
...
class StatisticsActiveSponsorTest(unittest.TestCase):
    ...
    def test_statistics_active_sponsor(self):
        ...
        # get statistics active sponsor
        res = self.client().get(
            '/statistics/activesponsorsgraphic/{}/{}'.format(
