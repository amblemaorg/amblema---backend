...
class MonitoringActivity(EmbeddedDocument):
    environmentActivities = fields.EmbeddedDocumentListField(
        DetailActivity, max_length=4)
    readingActivities = fields.EmbeddedDocumentListField(
        DetailActivity, max_length=4)
    mathActivities = fields.EmbeddedDocumentListField(
        DetailActivity, max_length=4)
