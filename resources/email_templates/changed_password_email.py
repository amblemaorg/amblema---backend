                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:5px 5px 0px 5px">
                                                            <h3 style="margin:30px 0 20px 0;font-size:30px;color:#008096;font-weight:bold;">Cambio de contraseña</h3>
                                                            <p style="margin:0px 10px 15px 10px;color: #008096;font-weight:bold;line-height:22px;text-align:center;">
                                                                ...
                                                                Ingresa a nuestra página con las siguientes credenciales:</p>
      ...
      background-image: url("""+current_app.config.get('SERVER_URL')+"""/resources/images/mailing/register-background.png);">
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="center">
                                                                            <br>
                                                                            <p style="padding: 70px 85px 0px 85px;color: #008096;font-weight:bold;line-height:22px">
                                                                                Si quieres contactar con nuestro equipo, no dudes en hacerlo a través de info@amblema.org
                                                                            </p>
                                                                            <p style="margin:20px 10px 0px 10px;color: #008096;font-weight:bold;line-height:20px">Ten un excelente día</p>
                                                                            <p style="margin:0px 10px 20px 10px;color: #008096;font-weight:bold;line-height:20px">Fundación AmbLeMa</p> 
                                                                            <br>
                                                                            <br>
                                                                            <br>
                                                                            <br>
...
def changedPasswordEmailPlainText(email, password):
    return """
  Amblema - Cambio de contraseña

  
  Su contraseña ha sido actualizada. Ingresa a nuestra página con las siguientes credenciales:
